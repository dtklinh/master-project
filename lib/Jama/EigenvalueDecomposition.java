...
/* 435 */         this.e[m] = 0.0D;
/*     */       }
/* 437 */       for (i1 = Math.max(m - 1, 0); i1 < i; i1++) {
...
/*     */               }
/*     */ 
/* 668 */               for (i5 = 0; i5 <= Math.min(j, i3 + 3); i5++) {
...
/*     */     }
/*     */ 
/* 841 */     for (i1 = i - 1; i1 >= d1; i1--)
/* 842 */       for (i2 = d1; i2 <= k; i2++) {
/* 843 */         d8 = 0.0D;
/* 844 */         for (d14 = d1; d14 <= Math.min(i1, k); d14++) {
/* 845 */           d8 += this.V[i2][d14] * this.H[d14][i1];
/*     */         }
/* 847 */         this.V[i2][i1] = d8;
/*     */       }
/*     */   }
