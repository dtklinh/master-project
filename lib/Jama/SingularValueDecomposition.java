...
/*     */     }
/*     */ 
/* 179 */     i3 = Math.min(this.n, this.m + 1);
/* 180 */     if (i1 < this.n) {
...
/*     */     int i8;
/* 193 */     if (j != 0) {
/* 194 */       for (i4 = i1; i4 < i; i4++) {
/* 195 */         for (i6 = 0; i6 < this.m; i6++) {
/* 196 */           this.U[i6][i4] = 0.0D;
/*     */         }
/* 198 */         this.U[i4][i4] = 1.0D;
/*     */       }
/* 200 */       for (i4 = i1 - 1; i4 >= 0; i4--) {
/* 201 */         if (this.s[i4] != 0.0D) {
/* 202 */           for (i6 = i4 + 1; i6 < i; i6++) {
/* 203 */             d3 = 0.0D;
...
/*     */ 
/* 230 */     if (k != 0) {
/* 231 */       for (i4 = this.n - 1; i4 >= 0; i4--) {
/* 232 */         if (((i4 < i2 ? 1 : 0) & (arrayOfDouble1[i4] != 0.0D ? 1 : 0)) != 0) {
/* 233 */           for (i6 = i4 + 1; i6 < i; i6++) {
/* 234 */             d3 = 0.0D;
...
/*     */       }
/*     */       else {
/* 286 */         for (int i11 = i3 - 1; (i11 >= i9) && 
/* 287 */           (i11 != i9); i11--)
/*     */         {
/* 290 */           double d7 = (i11 != i3 ? Math.abs(arrayOfDouble1[i11]) : 0.0D) + (i11 != i9 + 1 ? Math.abs(arrayOfDouble1[(i11 - 1)]) : 0.0D);
/*     */ 
