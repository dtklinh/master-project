...
public class MyDraw extends Applet {
    ...
    private ArrayList<String> ProtPosition;
    ...
    public MyDraw(String t, ArrayList<String> p, ArrayList<Double> v){
        this.Title = t;
        this.ProtPosition = p;
        this.Value = v;
    }
...
//        final MyJFreeChart demo = new MyJFreeChart(this.Title);
    ...
    public void PaintJFrame() {
        ...
        f.getContentPane().add(new ChartPanel(val,pos,this.Title));
