...
/*      */ public class Matrix
    ...
    /*      */ public Matrix(int paramInt1, int paramInt2, double paramDouble) /*      */ {
        ...
        /*   98 */ for (int i = 0; i < paramInt1; i++) /*   99 */ {
            for (int j = 0; j < paramInt2; j++) /*  100 */ {
    ...
    /*      */ public Matrix(double[] paramArrayOfDouble, int paramInt) /*      */ {
        ...
        /*  147 */ for (int i = 0; i < paramInt; i++) /*  148 */ {
            for (int j = 0; j < this.n; j++) /*  149 */ {
    ...
    /*      */ public Matrix getMatrix(int paramInt1, int paramInt2, int paramInt3, int paramInt4) /*      */ {
        ...
        /*      */ try {
            /*  291 */ for (int i = paramInt1; i <= paramInt2; i++) /*  292 */ {
                for (int j = paramInt3; j <= paramInt4; j++) /*  293 */ {
    ...
    /*      */ public Matrix getMatrix(int[] paramArrayOfInt1, int[] paramArrayOfInt2) /*      */ {
        ...
        /*      */ try {
            /*  313 */ for (int i = 0; i < paramArrayOfInt1.length; i++) /*  314 */ {
                for (int j = 0; j < paramArrayOfInt2.length; j++) /*  315 */ {
    ...
    /*      */ public Matrix getMatrix(int paramInt1, int paramInt2, int[] paramArrayOfInt) /*      */ {
        ...
        /*      */ try {
            /*  336 */ for (int i = paramInt1; i <= paramInt2; i++) /*  337 */ {
                for (int j = 0; j < paramArrayOfInt.length; j++) /*  338 */ {
    ...
    /*      */ public Matrix getMatrix(int[] paramArrayOfInt, int paramInt1, int paramInt2) /*      */ {
        ...
        /*      */ try {
            /*  359 */ for (int i = 0; i < paramArrayOfInt.length; i++) /*  360 */ {
                for (int j = paramInt1; j <= paramInt2; j++) /*  361 */ {
    ...
    /*      */ public void setMatrix(int paramInt1, int paramInt2, int paramInt3, int paramInt4, Matrix paramMatrix) /*      */ {
        /*      */ try /*      */ {
            /*  392 */ for (int i = paramInt1; i <= paramInt2; i++) /*  393 */ {
                for (int j = paramInt3; j <= paramInt4; j++) /*  394 */ {
    ...
    /*      */ public void setMatrix(int[] paramArrayOfInt1, int[] paramArrayOfInt2, Matrix paramMatrix) /*      */ {
        /*      */ try /*      */ {
            /*  411 */ for (int i = 0; i < paramArrayOfInt1.length; i++) /*  412 */ {
                for (int j = 0; j < paramArrayOfInt2.length; j++) /*  413 */ {
    ...
    /*      */ public void setMatrix(int[] paramArrayOfInt, int paramInt1, int paramInt2, Matrix paramMatrix) /*      */ {
        /*      */ try /*      */ {
            /*  431 */ for (int i = 0; i < paramArrayOfInt.length; i++) /*  432 */ {
                for (int j = paramInt1; j <= paramInt2; j++) /*  433 */ {
    ...
    /*      */ public void setMatrix(int paramInt1, int paramInt2, int[] paramArrayOfInt, Matrix paramMatrix) /*      */ {
        /*      */ try /*      */ {
            /*  451 */ for (int i = paramInt1; i <= paramInt2; i++) /*  452 */ {
                for (int j = 0; j < paramArrayOfInt.length; j++) /*  453 */ {
    ...
    /*      */ public static Matrix read(BufferedReader paramBufferedReader)
        ...
        /* 1002 */ if (localStreamTokenizer.ttype == -1) /* 1003 */ {
    ...
    /*      */ private void checkMatrixDimensions(Matrix paramMatrix) /*      */ {
        /* 1040 */ if ((paramMatrix.m != this.m) || (paramMatrix.n != this.n)) /* 1041 */ {
            throw new IllegalArgumentException("Matrix dimensions must agree.");
        }
        /*      */    }

    public double CalculateUValue() {
        double[][] freqMatrix = this.A;
        try {
            if (freqMatrix == null) {
                return -1.0;
            }
        ...
        for (int i = 0; i < freqMatrix.length; ++i) {
            double lineSum = 0.0;
            for (int j = 0; j < freqMatrix.length; ++j) {
                lineSum += (freqMatrix[i][j] / sum);
            }
            if (lineSum != 0) {
                Hi += (lineSum * (Math.log(lineSum) / Math.log(2)));
            }
        }
        Hi *= -1;
        double Hj = 0.0;
        for (int i = 0; i < freqMatrix.length; ++i) {
            ...
            for (int j = 0; j < freqMatrix.length; ++j) {
                columnSum += (freqMatrix[j][i] / sum);
            }
            if (columnSum != 0) {
                Hj += (columnSum * (Math.log(columnSum) / Math.log(2)));
            }
        }
        Hj *= -1;
        double Hij = 0.0;
        for (int i = 0; i < freqMatrix.length; ++i) {
            for (int j = 0; j < freqMatrix.length; ++j) {
                if (freqMatrix[i][j] != 0) {
                    Hij += ((freqMatrix[i][j] / sum) * (Math.log((freqMatrix[i][j]) / sum) / Math.log(2)));
                }
            }
        }
        Hij *= -1;
